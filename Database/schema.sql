...
CREATE TABLE lab_test_appointments (
    ...
    CONSTRAINT fk_lta_test FOREIGN KEY (test_id) REFERENCES tests(id)
);
...
-- 19. BILL_PAYING 
CREATE TABLE bill_paying (
    id              NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
    bills_id        NUMBER NOT NULL,
    bill_receipt_id NUMBER NOT NULL,
    CONSTRAINT fk_bp_bill FOREIGN KEY (bills_id) REFERENCES bills(id),
    CONSTRAINT fk_bp_rec FOREIGN KEY (bill_receipt_id) REFERENCES bill_receipt(id)
);
...
CREATE TABLE tests (
    ...
    CONSTRAINT fk_test_tech FOREIGN KEY (technician_id) REFERENCES medical_technician(id),
    CONSTRAINT fk_test_adm FOREIGN KEY (admin_id) REFERENCES admin(id)
);
-- Linking Admin to Branch
ALTER TABLE admin 
ADD CONSTRAINT fk_admin_branch 
FOREIGN KEY (branch_id) REFERENCES hospital_branches(id);

-- Linking Branch back to Admin
ALTER TABLE hospital_branches 
ADD CONSTRAINT fk_branch_admin 
